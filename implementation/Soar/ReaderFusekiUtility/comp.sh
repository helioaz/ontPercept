...
#javac -g -d ./ -classpath "./*:/home/hazevedo/localbin/apache-jena-3.2.0/lib/*:/home/hazevedo/Dropbox/02_Tese_Doutorado/DesenvolvimentoTese/Implementacao/OntSenseJavaAPI/*"  *.java
